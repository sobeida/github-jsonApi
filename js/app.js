// http://api.github.com/users/sobeida

/*
        function getProfile() {
            var username = 'sobeida';
...
// With JSON + Panel from Bootstrap
...
function getProfile(e) {
    ...
    if (!username || username == '') {
        username = 'bradtraversey';
        // or yours 'sobeida' or any other
    }
...
<span class="label label-danger">Public Gists ${user.gists}</span>
<br><br>
<ul class="list-group">
